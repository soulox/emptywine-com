    ...
    <div class="editor-body">
      ...
      <div class="field">
        <div class="field-row">
          ...
          <div class="seg" id="vintage-format" role="group" aria-label="${lang === 'fr' ? 'Format du millésime' : 'Vintage numeral format'}">
...
<div class="dl-overlay" id="dl-overlay" hidden>
  <div class="dl-card" role="dialog" aria-modal="true" aria-labelledby="dl-title">
    <button type="button" class="dl-close" id="dl-close" aria-label="${lang === 'fr' ? 'Fermer' : 'Close'}">×</button>
...
(function() {
  ...
  function updateLabel() {
    ...
    document.getElementById('lbl-varietal').textContent    = varietal || '${lang === 'fr' ? 'Bourgogne · Pinot Noir' : 'Burgundy · Pinot Noir'}';
    renderVintage();
  }
  ...
  async function exportLabel(fmt, btn) {
    ...
    try {
      ...
      sub.textContent = '${lang === 'fr' ? 'échec — réessayer' : 'failed — retry'}';
    }
