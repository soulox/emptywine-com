/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0a81aed7b8eb3db0843075a3b1892ae1)
// Runtime types generated with workerd@1.20250617.0 2025-10-08 
declare namespace Cloudflare {
	interface Env {
		CONTACTS: KVNamespace;
		SMTP_HOST: "mail02.outsourceis.com";
		SMTP_PORT: "465";
		SMTP_SECURITY: "tls";
		SMTP_USER: "no-reply@emptywine.com";
		SMTP_FROM: "no-reply@emptywine.com";
		PUBLIC_ORIGIN: "https://emptywine.com";
		ADMIN_TOKEN: string;
